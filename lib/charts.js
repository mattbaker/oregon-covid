...
function renderStackedCaseChart(_ref) {
  ...
  var xAxis = function xAxis(g) {
    ...
    return g.attr("transform", "translate(0, ".concat(height - margin.bottom, ")")).call(axis).selectAll("text").attr("class", "axis-text numeral").style("text-anchor", "end").attr("dx", "-.8em").attr("dy", ".15em").attr("transform", "rotate(-65)");
  };
